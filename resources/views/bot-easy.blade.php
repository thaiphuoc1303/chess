        ...
        <div class="container">
            <div class="col-md-9">
                <div id="batdau" style="text-align: center" class="col-md-12">
                    <h3>Chơi với máy mức dễ</h3>
                    <br>
                    <button type="button" onclick="batdau()" id="batdau" class="btn easy btn-success btn-sm">Bắt đầu</button>
                </div>
                <br>
...
<body>
    <div class="menu" id="difficulty">
        <br>
        <hr><br>
        <button type="button" class="btn easy btn-success btn-sm">Bắt đầu</button>
        <br><br>
