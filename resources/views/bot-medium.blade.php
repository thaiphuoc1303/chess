...
@section('main')
    <div class="page-content-product">
        <div class="main-product"  style="min-height: 50%; max-height: 50%; color: white">
            <div class="container">
                <div class="col-md-9">
                    <div id="batdau" style="text-align: center" class="col-md-12">
                        <h3>Chơi với máy mức vừa</h3>
                        <br><br>
                        <button type="button" onclick="batdau()" id="batdau" class="btn medium btn-success btn-sm">Bắt
                            đầu</button>
                    </div>
                    <br>
